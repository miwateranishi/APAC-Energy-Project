...
for datafile in datafiles:
    ...
    if not os.path.exists(filename): #only saves the file if a file with the same name does not exist
        ...
        zip.extractall(r'//Apac-intern-vm3/c$/Users/thanh/Desktop/Solar_Power_Generation/')
        zip.extractall(r'//Mtippett-vm1/c$/Users/thanh/Desktop/Solar_Power_Generation/')
        zip.extractall(r'//Mtippett-vm2/c$/Users/thanh/Desktop/Solar_Power_Generation/')
        zip.extractall(r'//Mtippett-vm3/c$/Users/thanh/Desktop/Solar_Power_Generation/')
